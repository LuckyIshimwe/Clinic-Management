...
export default function DoctorDashboard() {
  ...
  const fetchStudentHistory = async (studentId) => {
    try {
      ...
      console.log('Student history response:', res.data);
      const visitsData = res.data.visits || res.data || [];
      setHealthVisits(Array.isArray(visitsData) ? visitsData : []);
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white border border-gray-300 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-600 uppercase tracking-wide">Pending Reviews</p>
                <p className="text-2xl font-bold text-gray-900 mt-1">{pendingReviews.length}</p>
              </div>
          ...
          <div className="bg-white border border-gray-300 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-600 uppercase tracking-wide">Critical Cases</p>
                <p className="text-2xl font-bold text-gray-900 mt-1">
                  {pendingReviews.filter(v => v.severity === 'high' || v.labResults?.criticalValues).length}
                </p>
              </div>
          ...
          <div className="bg-white border border-gray-300 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-gray-600 uppercase tracking-wide">With Allergies</p>
                <p className="text-2xl font-bold text-gray-900 mt-1">
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex flex-col items-end gap-1">
                          {visit.severity === 'high' && (
                            <span className="px-2 py-0.5 bg-red-100 text-red-700 text-xs font-semibold">
                              HIGH
                            </span>
                          )}
                          {visit.labResults?.criticalValues && (
                            <span className="px-2 py-0.5 bg-red-600 text-white text-xs font-semibold">
                              CRITICAL
                            </span>
                          )}
                        </div>
                  ...
                  <div className="bg-white border border-gray-300 p-6">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-gray-900 hover:bg-gray-800 text-white text-sm font-medium transition-colors"
                      >
                        Complete Review
                      </button>
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-3 mb-4">
                      <div className="border border-gray-300 p-3">
                        ...
                        <p className="text-sm font-semibold text-gray-900">{selectedVisit.age} years</p>
                      </div>
                      <div className="border border-gray-300 p-3">
                        <p className="text-xs text-gray-600 mb-1">Gender</p>
                        <p className="text-sm font-semibold text-gray-900">{selectedVisit.gender}</p>
                      </div>
                      <div className="border border-gray-300 p-3">
                        <p className="text-xs text-gray-600 mb-1">Blood Group</p>
                        <p className="text-sm font-semibold text-gray-900">{selectedVisit.bloodGroup || 'N/A'}</p>
                      </div>
                      <div className="border border-gray-300 p-3">
                        <p className="text-xs text-gray-600 mb-1">Severity</p>
                        <p className="text-sm font-semibold text-gray-900 capitalize">{selectedVisit.severity}</p>
                      </div>
                    </div>

                    {selectedVisit.allergies && (
                      <div className="bg-red-50 border border-red-300 p-4 mb-4">
                        <p className="text-sm font-semibold text-red-900">⚠️ Allergies: {selectedVisit.allergies}</p>
                      </div>
                    )}

                    {selectedVisit.chronicConditions && (
                      <div className="bg-yellow-50 border border-yellow-300 p-4">
                        <p className="text-sm font-semibold text-yellow-900">Chronic: {selectedVisit.chronicConditions}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-white border border-gray-300 p-5">
                    ...
                    <div className="space-y-3">
                      <div className="bg-gray-50 border border-gray-300 p-4">
                        ...
                        <p className="text-sm text-gray-900">{selectedVisit.chiefComplaint}</p>
                      </div>

                      <div className="border border-gray-300 p-4">
                        <p className="text-xs font-semibold text-gray-600 mb-1">Symptoms</p>
                        <p className="text-sm text-gray-900">{selectedVisit.symptoms}</p>
                      </div>

                      {selectedVisit.nurseAssessment && (
                        <div className="border border-gray-300 p-4">
                          <p className="text-xs font-semibold text-gray-600 mb-1">Nurse Assessment</p>
                          <p className="text-sm text-gray-900">{selectedVisit.nurseAssessment}</p>
                        </div>
                      )}
                    ...
                    <div className="bg-white border border-gray-300 p-5">
                      ...
                      <div className="space-y-3">
                        <div className="bg-purple-50 border border-purple-300 p-4">
                          ...
                          <p className="text-sm text-gray-900 whitespace-pre-wrap">{selectedVisit.labResults.results}</p>
                        </div>

                        {selectedVisit.labResults.findings && (
                          <div className="border border-gray-300 p-4">
                            <p className="text-xs font-semibold text-gray-600 mb-1">Findings</p>
                            <p className="text-sm text-gray-900">{selectedVisit.labResults.findings}</p>
                          </div>
                        )}
                        ...
                        {selectedVisit.labResults.interpretation && (
                          <div className="border border-gray-300 p-4">
                            ...
                            <p className="text-sm text-gray-900">{selectedVisit.labResults.interpretation}</p>
                          </div>
                        )}

                        <div className="flex gap-2">
                          {selectedVisit.labResults.abnormalFindings && (
                            <div className="flex-1 bg-orange-50 border border-orange-300 p-3 text-center">
                              <p className="text-xs font-semibold text-orange-900">⚠️ Abnormal</p>
                            </div>
                          )}
                          {selectedVisit.labResults.criticalValues && (
                            <div className="flex-1 bg-red-50 border border-red-300 p-3 text-center">
                              ...
                              {visit.doctorDiagnosis && (
                                <div className="mt-3 pt-3 border-t border-gray-200">
                                  <p className="text-xs text-gray-600">
                                    <span className="font-semibold">Diagnosis:</span> {visit.doctorDiagnosis}
                                  </p>
                                  {visit.doctorTreatment && (
                                    <p className="text-xs text-gray-600 mt-1">
                                      <span className="font-semibold">Treatment:</span> {visit.doctorTreatment}
                                    </p>
                                  )}
                                </div>
                              )}
      ...
      {showDetailsModal && selectedStudent && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="border-b border-gray-300 px-6 py-4 flex items-center justify-between sticky top-0 bg-white">
              <h2 className="text-xl font-semibold text-gray-900">
                Patient Details - {selectedStudent.fullName || 'Unknown'}
              </h2>
              <button
                onClick={() => {
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Full Name</label>
                    <p className="text-sm font-medium text-gray-900">{selectedStudent.fullName || 'Unknown'}</p>
                  </div>
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Student ID</label>
                    <p className="text-sm font-medium text-gray-900">{selectedStudent.studentId || 'N/A'}</p>
                  </div>
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Grade/Section</label>
                    <p className="text-sm font-medium text-gray-900">
                      {selectedStudent.grade || 'N/A'}{selectedStudent.section ? `-${selectedStudent.section}` : ''}
                    </p>
                  </div>
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Age</label>
                    <p className="text-sm font-medium text-gray-900">{selectedStudent.age || 'N/A'} years</p>
                  </div>
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Gender</label>
                  ...
                  <div>
                    <label className="block text-xs text-gray-600 mb-1">Blood Group</label>
                    <p className="text-sm font-medium text-gray-900">{selectedStudent.bloodGroup || 'Unknown'}</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {selectedStudent.parentContact.fatherName && (
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">{selectedStudent.parentContact.fatherName}</p>
                      </div>
                    )}
                    {selectedStudent.parentContact.fatherPhone && (
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Father's Phone</label>
                        <p className="text-sm font-medium text-gray-900">{selectedStudent.parentContact.fatherPhone}</p>
                      </div>
                    )}
                    {selectedStudent.parentContact.motherName && (
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Mother's Name</label>
                        <p className="text-sm font-medium text-gray-900">{selectedStudent.parentContact.motherName}</p>
                      </div>
                    )}
                    {selectedStudent.parentContact.motherPhone && (
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Mother's Phone</label>
                        <p className="text-sm font-medium text-gray-900">{selectedStudent.parentContact.motherPhone}</p>
                      </div>
                    )}
                    {selectedStudent.parentContact.emergencyPhone && (
                      <div className="col-span-2">
                        <label className="block text-xs text-gray-600 mb-1">Emergency Phone</label>
                        <p className="text-sm font-medium text-gray-900">{selectedStudent.parentContact.emergencyPhone}</p>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {healthVisits.map((visit) => (
                      <div key={visit._id} className="border border-gray-300 p-4">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <p className="text-sm font-semibold text-gray-900">{visit.chiefComplaint || 'Not specified'}</p>
                            <p className="text-xs text-gray-600 mt-1">{visit.symptoms || 'No symptoms recorded'}</p>
                          </div>
                          <div className="text-right">
                            <span className="inline-block px-2 py-1 text-xs font-medium border border-gray-300">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleReview} className="p-6 space-y-4">
              <div>
                <label className="block text-xs text-gray-600 mb-2">Diagnosis *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs text-gray-600 mb-2">Treatment Plan *</label>
                <textarea
                  required
              ...
              <div className="border-t border-gray-300 pt-4">
                ...
                <div className="space-y-2">
                  <label className="flex items-start gap-3 p-3 border border-gray-300 cursor-pointer hover:bg-gray-50">
                    ...
                    />
                    <div>
                      <p className="text-sm font-medium text-gray-900">Complete Treatment</p>
                  ...
                  <label className="flex items-start gap-3 p-3 border border-gray-300 cursor-pointer hover:bg-gray-50">
                    ...
                    />
                    <div>
                      <p className="text-sm font-medium text-gray-900">Prescribe Medication</p>
                  ...
                  <label className="flex items-start gap-3 p-3 border border-gray-300 cursor-pointer hover:bg-gray-50">
                    ...
                    />
                    <div>
                      <p className="text-sm font-medium text-gray-900">Refer to Specialist</p>
                  ...
                  <label className="flex items-start gap-3 p-3 border border-gray-300 cursor-pointer hover:bg-gray-50">
                    ...
                    />
                    <div>
                      <p className="text-sm font-medium text-gray-900">Hospitalize</p>
              ...
              {reviewForm.actionTaken === 'prescribe' && (
                <div className="bg-gray-50 border border-gray-300 p-4 space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={addMedicine}
                    className="w-full px-3 py-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-900 text-sm font-medium"
                  >
                    + Add Medicine
                  </button>
                </div>
              ...
              {reviewForm.actionTaken === 'refer' && (
                <div className="bg-gray-50 border border-gray-300 p-4 space-y-3">
                  ...
                  <div>
                    <label className="block text-xs text-gray-600 mb-2">Referred To *</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-xs text-gray-600 mb-2">Reason *</label>
                    <textarea
                      required
