...
export default function PharmacistDashboard() {
  ...
  const fetchPrescriptions = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.get(`${baseURL}/report/prescriptions`, {
  ...
  const handleDispense = async (prescriptionId) => {
    try {
      ...
      // Refresh prescriptions and update selected
      await fetchPrescriptions();
      
      if (selectedPrescription && selectedPrescription._id === prescriptionId) {
        setSelectedPrescription(response.data.prescription || null);
      }
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-5 bg-white rounded-2xl shadow-sm p-5">
            <h2 className="text-base font-semibold text-gray-800 mb-4">Prescriptions</h2>
                ...
                <div className="bg-gray-50 p-4 rounded-xl mb-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-800">{selectedPrescription.status}</p>
                    </div>
                  </div>
                </div>
